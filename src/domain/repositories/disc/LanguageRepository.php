...
namespace yii2bundle\i18n\domain\repositories\disc;
...
use yii2bundle\i18n\domain\interfaces\repositories\LanguageInterface;

class LanguageRepository extends BaseActiveDiscRepository implements LanguageInterface {
	
	public $table = 'languages';
	public $path = '@yii2bundle/i18n/domain/data';
	public $callback;
